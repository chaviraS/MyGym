	...
	<body>
		...
		<div id="show-ejercicio" class="content scaffold-show" role="main">
			...
			<ol class="property-list ejercicio">
				...
				<g:if test="${ejercicioInstance?.ejercicio}">
				<li class="fieldcontain">
					<span id="ejercicio-label" class="property-label"><g:message code="ejercicio.ejercicio.label" default="Ejercicio" /></span>
					
						<span class="property-value" aria-labelledby="ejercicio-label"><g:fieldValue bean="${ejercicioInstance}" field="ejercicio"/></span>
				...
				<li class="fieldcontain">
					<span id="rutina-label" class="property-label"><g:message code="ejercicio.rutina.label" default="Rutina" /></span>
						...
						<span class="property-value" aria-labelledby="rutina-label"><g:link controller="rutina" action="show" id="${ejercicioInstance?.rutina?.id}">${ejercicioInstance?.rutina?.encodeAsHTML()}</g:link></span>
